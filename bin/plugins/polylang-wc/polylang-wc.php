...
class Polylang_Woocommerce {
	...
	public function init() {
		...
		// Move before any language test to display the WooCommerce step in the Wizard.
		// @since 1.4
		if ( PLL() instanceof PLL_admin_Base ) {
	...
	/**
	 * Save a activation transient when Polylang For WooCommerce is activating to redirect to Polylang wizard
	 *
